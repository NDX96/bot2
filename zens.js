...
const nyoutube = ('ANYA-BOT BETA V2')  //ubah di config biar ngk emror
...
module.exports = zens = async (zens, m, chatUpdate, store) => {
    try {
	    ...
	    //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thumb, surface: 200, message: 'ANYA-BOT V2', orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: 'ANYA-BOT V2',jpegThumbnail: thumb}}}
		const fvn = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":'ANYA-BOT V2', "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': 'ANYA-BOT BETA', 'jpegThumbnail': thumb}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "WhatsApp", "caption": 'ANYA-BOT', 'jpegThumbnail': thumb}}}
		...
		const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: 'Larangan, Jawa Tengah, Indonesia',jpegThumbnail: thumb}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'Yusuf Andika', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Zenss,;;;\nFN:ZenssCuyy\nitem1.TEL;waid=6283181933754:628181933754\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": 'BOT TERVERIFIKASI',"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./image/zens.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
Dilarang spam/telp`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Owner' }, type: 1 }]
...
case 'woy':
case 'woi': {
            	let any = ['iya??','kenapa kak??','ish apasi','ooiiiyyyy','apasi','ha?','kamu siapa?','aaaaaapppppaaaaaaa','hmmmmzzzzzz_-','sok asik bgt','huuuu sok kenal','manggil skli lagi aku toniok nih','sstttt brisik']
                let nya = any[Math.floor(Math.random() * any.length)]
                let sendd = `${nya}`
                m.reply(`${sendd}`)
            }
            break
...
{    
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let jawab = `hi kak ${pushname} ${ucapanWaktu}
aku anyaa dan dibawah list menunyaaa:)
...
•setmenu`
            ...
            let buttons = [{ buttonId: 'owner', buttonText: { displayText: 'owner' }, type: 1 },{ buttonId: 'ping', buttonText: { displayText: 'ping' }, type: 1 }]
            await zens.sendButtonText(m.chat, buttons, jawab, `kenalin saya Anya Forger:D
pemiliknya si @${ownernya.split('@')[0]} -_-
${zens.public ? 'semua orang' : `cuma owner yang`} bisa perintah anya:)
kamu pasti ${pushname} yakan??
oiya btw limit kamu ${isPremium ? 'Infinity' : `sisa ${db.data.users[m.sender].limit}`} nih
jangan lupa chat owner ya:)
terima kasih @${ini_mark.split('@')[0]}

oiya ini jam ${barat}`, m, {mentions: ments, quoted: fkontak})
            } 
break
