...
async function startNaze() {
    const naze = nazeConnect({
        ...
        browser: ['OCHO-BOT','Firefox','1.0.0'],
        auth: state
    })
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await naze.getName(i + '@s.whatsapp.net')}\nFN:${await naze.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET: hiipatrick1010@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/yusuf.andika24\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
    ...
    naze.public = true
	 naze.autosw = false
	 naze.sendsw = '6283181933754@s.whatsapp.net'
